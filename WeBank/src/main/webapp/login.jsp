...
<div class="container">
    ...
    <form class="form-signin" method="post" action="login">
        <h2 class="form-signin-heading">登录系统</h2><p style="color:red;">${msg}</p>
       ...
       <img src="img2.jsp" onclick="this.src='img2.jsp?'+new Date()" 
		style="margin-bottom: 15px;width:100px; height:35px" />
